...
ciclo_terminal((Matriz,UltPecaJog),Modo):-
...
ciclo(1,Matriz,Modo):-
 ...
 ciclo(2,Matriz,hvsh):-
   ...
   read(Coluna), write(Coluna),nl,
   (insere(b,Coluna,(Matriz,UltPecaJog)), ciclo(1,(Matriz,UltPecaJog),hvsh));(ciclo(2,Matriz,hvsh)).
